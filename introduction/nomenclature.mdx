...
A: Yes! With Edgit, ensembles can be versioned independently using `edgit tag create my-ensemble v1.0.0 --type=ensemble`. They reference versioned agents and components, and the ensemble itself can be version-pinned.

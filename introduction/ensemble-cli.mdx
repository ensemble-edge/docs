...
ensemble edgit tag set my-prompt prod v1.0.0
ensemble edgit push --tags --force

# List component tags
ensemble edgit tag list my-prompt
...
💡 Deploy this version:
  • Run 'ensemble edgit tag set my-prompt staging v1.0.0'
  • Then 'ensemble edgit push --tags --force'
```

---
title: "Overview"
description: "A developer-first platform for building AI workflows that you actually control"
---
...
agents:
  ...
  - name: score
    agent: validator         # Use starter kit agent
    input:
...
<AccordionGroup>
  ...
  <Accordion icon="magnifying-glass" title="RAG System">
    ...
    Agents: RAG (starter kit) + Think (generation) + vectorize
  </Accordion>

...
<AccordionGroup>
  ...
  <Accordion icon="linux" title="Linux">
    ...
    sudo npm install -g @ensemble-edge/edgit
    ```
  </Accordion>
...
<Tabs>
  <Tab title="Global Installation">
    ```bash
    npm update -g @ensemble-edge/edgit
    ```
  ...
  <Tab title="Project Installation">
    ```bash
    npm update @ensemble-edge/edgit
    ```

    Or to latest version:
    ```bash
    npm install @ensemble-edge/edgit@latest --save-dev
    ```
  </Tab>
...
<Tabs>
  <Tab title="Global Installation">
    ```bash
    npm uninstall -g @ensemble-edge/edgit
    ```
  </Tab>

  <Tab title="Project Installation">
    ```bash
    npm uninstall @ensemble-edge/edgit
    ```
  </Tab>

  <Tab title="From Source">
    ```bash
    npm unlink @ensemble-edge/edgit
    ```
  </Tab>
</Tabs>
...
edgit tag -l "*-v*" | xargs edgit tag -d
```
...
<AccordionGroup>
  <Accordion title="Command not found: edgit">
    ...
    **Solutions**:
    1. Verify installation: `npm list -g @ensemble-edge/edgit`

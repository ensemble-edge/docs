...
<Steps>
  ...
  <Step title="Navigate to your Git repository">
    ...
    edgit status  # Verify you're in a Git repo
    ```
...
<Steps>
  ...
  <Step title="Push to remote">
    ```bash
    edgit push origin hello-v1.0.0
    ```
...
<AccordionGroup>
  ...
  <Accordion title="Error: Not a Git repository">
    ...
    **Solution**: Initialize Git first
    ...
    edgit init
    edgit add .
    edgit commit -m "Initial commit"
    edgit init  # Initialize edgit registry
    ```
  </Accordion>

...
description: "Test multiple versions simultaneously with infinite combinations"
---

# A/B Testing & Multivariate

**The version multiverse unlocked: test any combination of components and agents simultaneously.**
...
if prob_treatment_better > 0.95:
    ...
    print("ø  Inconclusive. Collect more data.")
```
...
if control_total < min_sample_size or treatment_total < min_sample_size:
    print("ø  Not enough data yet. Keep collecting.")
```

...
The recommended way to use Edgit is through the unified Ensemble CLI:
...
<Note>
All examples below show the direct `edgit` command. Prefix with `ensemble` when using the unified CLI.
</Note>

...
**Machine learning model inference with Workers AI and custom models.**

The `ml` operation enables running machine learning models at the edge for image classification, object detection, embeddings, and more.

...
description: "Send emails with templates, attachments, and multi-provider support"
---

# email Operation

**Send transactional and marketing emails via Cloudflare Email, Resend, or SMTP with template rendering, batch processing, and attachment support.**

The `email` operation handles all email sending needs - from simple transactional messages to complex batch campaigns with personalized templates and file attachments.

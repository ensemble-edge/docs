...
**Execute custom JavaScript/TypeScript for data transformation, business logic, calculations, and any task that doesn't require AI or external services.**

The `code` operation is fast, free, and fully under your control. Use it for transformations, validations, calculations, and custom logic.

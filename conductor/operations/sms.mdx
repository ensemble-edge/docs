---
title: "sms Operation"
description: "Send SMS and MMS messages via Twilio, Vonage, or AWS SNS with template rendering, batch processing, and E.164 validation. For OTP codes, alerts, notifications, and 2FA with 98% open rates and instant delivery."
---

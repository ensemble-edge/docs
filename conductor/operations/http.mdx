...
**Make HTTP requests to external APIs, webhooks, and microservices.**

The `http` operation handles URLs, methods, headers, body, timeouts, retries, and response parsing automatically.

...
description: "Unified interface to Cloudflare storage: KV (key-value), D1 (SQL), R2 (objects), Vectorize (vectors)"
---

Access all Cloudflare data primitives with automatic binding resolution.

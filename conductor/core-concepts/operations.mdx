---
title: "Operations"
description: "Execution primitives that power Conductor. Operations are atomic actions you compose into workflows."
---
...
<CardGroup cols={3}>
  ...
  <Card title="html" icon="browser" href="/conductor/operations/html">
    Full-stack pages
  </Card>
...
<Info>
  **Documentation**: The `docs/` directory is a first-class component for API documentation.
  See [Building Documentation](/conductor/building/documentation).
</Info>
...
Process background jobs and messages.

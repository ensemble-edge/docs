...
description: "Share data across agents without prop drilling"
---

# State Management

**State lets agents share data without passing it through every agent. Define it once, access it anywhere.**

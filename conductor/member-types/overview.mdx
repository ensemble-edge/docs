...
description: "Four member types for building AI workflows"
---

## Overview

Conductor provides four member types, each optimized for specific tasks. Think of them as different instruments in your orchestra - each plays a unique role.

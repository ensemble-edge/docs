...
description: "Nine member types for building AI workflows"
---

## Overview

Conductor provides nine member types, each optimized for specific tasks. Think of them as different instruments in your orchestra - each plays a unique role.
...
<CardGroup cols={2}>
  ...
  <Card title="PDF" icon="file-pdf" href="/conductor/member-types/pdf">
    PDF generation from HTML with R2 storage and delivery options
  </Card>

  <Card title="Page" icon="browser" href="/conductor/member-types/page">
    Full-stack pages with SSR, dynamic routing, and htmx hydration
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  ...
  <Card
    title="Page Members"
    icon="browser"
    href="/conductor/member-types/page"
  >
    Full-stack pages
  </Card>

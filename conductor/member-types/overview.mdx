...
description: "Eight member types for building AI workflows"
---

## Overview

Conductor provides eight member types, each optimized for specific tasks. Think of them as different instruments in your orchestra - each plays a unique role.

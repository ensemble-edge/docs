...
This workflow calls the `hello` agent (from `agents/hello/`) and returns its output.
...
agents:
  ...
  - name: greeter
    operation: code
    config:
      handler: hello  # Reference to agents/hello/
...
<CardGroup cols={2}>
  <Card title="Understanding Pages" icon="file" href="/conductor/core-concepts/pages">
    Learn how pages work and build web applications
  </Card>
...
4. **Test locally first** - `npm test` runs your test suite instantly

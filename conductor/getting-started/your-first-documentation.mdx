...
- 📖 Create a `docs/` directory with auto-generated API documentation
- ✍️ Write markdown documentation pages with frontmatter
- 🎨 Customize branding, themes, and navigation
...
- ✅ Create a `docs/` directory with `docs.yaml`
- ✅ Write markdown pages with frontmatter
- ✅ Configure navigation with ordering and groups

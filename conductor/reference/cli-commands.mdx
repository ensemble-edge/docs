...
|----------|-------------|-------|
| `cloudflare` | — | Built-in, no API key needed |
...
See [Checking for Updates](/introduction/ensemble-cli#checking-for-updates-landscape-view) for the full output format.
...
See [Upgrade Command](/introduction/ensemble-cli#upgrade-command) for detailed examples.

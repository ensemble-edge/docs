...
Show comprehensive project status including configuration, components, triggers, Cloudflare services, and deployment health.

```bash
ensemble conductor status [options]
```

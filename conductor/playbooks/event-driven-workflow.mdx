...
description: "React to events and triggers - webhooks, database changes, cron schedules, and user actions"
---

# Event-Driven Workflow Playbook

**Respond to events: webhooks, database changes, cron schedules, and user actions in real-time.**

Event-driven workflows react to triggers automatically, enabling asynchronous processing, real-time updates, and scheduled tasks without manual intervention.

...
<CardGroup cols={2}>
  ...
  <Card title="Triggers" icon="clock" href="/conductor/core-concepts/triggers">
  ...
  <Card title="Flow Control" icon="triangle-exclamation" href="/conductor/core-concepts/flow-control">

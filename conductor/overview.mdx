...
Conductor isn't just for backend workflows. It also includes **Pages** for building server-rendered web applications:

**Pages Features:**
- Static pages with Liquid/HTML templates
- Dynamic pages with handler functions
- Auto-discovery from `pages/` directory
- SEO, caching, and hydration built-in
- Dynamic route parameters (e.g., `/blog/:slug`)
...
component: |
  ...
  <div class="stats">
    <p>Total workflows: {{stats.total}}</p>

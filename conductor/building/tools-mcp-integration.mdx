...
description: "Build bidirectional MCP integrations - consume external tools and expose ensembles as MCP tools. Complete guide to Conductor's Model Context Protocol integration."
---

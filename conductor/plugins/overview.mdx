...
- Built-in operations (`fetch-data`, `transform-data`, `custom-code`)
...
- [Understanding the Operation Registry](/conductor/plugins/operation-registry)
